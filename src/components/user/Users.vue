...
export default {
  ...
  data() {
    var checkEmail = (rule, value, cb) => {
      const regEmail = /^([a-zA-Z0-9])+@([a-zA-Z9-9_-])+(\.[a-zA-Z_-])+/
    ...
    var checkMobile = (rule, value, cb) => {
      const regMoble =
        /^(0|86|17951)?(13[0-9]|15[012356789]|17[678]|18[0-9]|14[47])[0-9]{8}$/
  ...
  methods: {
    ...
    handleSizeChange(newsize) {
      //   console.log(newsize)
      this.queryInfo.pagesize = newsizeuserStateChanged
      this.getUserList()
    },
